...
const SearchBar = ({
  ...
  return (
    <>
      <div className="wrapper mt-6 flex w-[90vw] max-w-[1100px] flex-col items-center space-y-6 md:mt-8 md:space-y-8">
        ...
        <div className="flex w-full overflow-hidden rounded-xl md:w-[40%]">
          <input
            ...
            className="w-full px-4 placeholder:text-sm focus:outline-none md:placeholder:text-base"
        ...
        <div className="space-y-4 rounded-xl bg-white p-6 text-center md:flex md:items-start md:justify-start md:space-x-8 md:space-y-0 md:py-10 md:text-left">
